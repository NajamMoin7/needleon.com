      ...
      <Container className="relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-center py-16 lg:py-24">
        <div className="space-y-7">
          ...
          <div className="flex flex-wrap gap-6 pt-4 text-xs text-ink-500">
            <span className="flex items-center gap-2"><IconTruck className="w-4 h-4 text-blush-500" /> Free shipping over Rs. 10,000</span>
            <span className="flex items-center gap-2"><IconShield className="w-4 h-4 text-blush-500" /> Easy 7-day returns</span>
          </div>
        </div>
      ...
      <div className="grid lg:grid-cols-2 rounded-3xl overflow-hidden shadow-soft bg-surface">
        ...
        <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <Button href="/boutique" size="lg">Book stitching service</Button>
    ...
    <Section bg="sand" spacing="md">
      ...
      <div className="mt-12 grid md:grid-cols-3 gap-6">
        {steps.map((s, i) => (
          <div
            key={s.title}
            className="bg-surface rounded-2xl p-7 shadow-soft hairline"
          >
    ...
    <Section bg="ink" spacing="md">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-wrap gap-3 md:justify-end">
          ...
          <Button href="/boutique" variant="outline" size="lg" className="!text-white !border-white/30 hover:!bg-white/10">
            Book stitching
          </Button>
        </div>
      </div>
